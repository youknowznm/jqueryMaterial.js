    ...
    initButton: function initButton() {
        this.each(function () {
            ...
            */
            ...
            // 浮动提示条
            $('body:not(#mobile)').on('mouseenter', '.show-tooltip', function (evt) {
