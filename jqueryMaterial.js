    ...
    initButton: function initButton() {
        this.each(function () {
            ...
            */
            ...
            // 浮动提示条
            $('html:not(#mobile)').on('mouseenter', '.show-tooltip', function (evt) {
...
$.fn.extend({
    ...
    */
    initRte: function initRte(options) {
        ...
        if (useRichText === true) {
            var _$currentLength = $rte.find('.current').text($editArea.text().length);
        }
