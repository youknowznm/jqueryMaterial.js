...
$.fn.extend({
    ...
    */
    initButton: function initButton(clickCallback) {
        this.each(function () {
            var $button = $(this);
            ...
            */
            ...
            $button.on('mousedown', function (evt) {
                if (!$button.hasClass('_disabled') && $button.data('animating') === false) {
                    ...
                    var _x = evt.offsetX;
                    var _y = evt.offsetY;
                    var _width = $button.innerWidth();
                    var _height = $button.innerHeight();
                ...
                if ($button.hasClass('show-tooltip')) {
                    var $tooltip = $('<p id="jm-tooltip" class="to-show-at-' + $button.data('tooltipPosition') + '">\n                                    ' + $button.data('tooltipContent') + '\n                                </p>');
                    $('body').append($tooltip);
    ...
    initHeader: function initHeader(options) {
        this.each(function () {
            var pageTitle = options.pageTitle,
                siteNameWords = options.siteNameWords,
            ...
            */
            ...
            $window.on('scroll', function (evt) {
                ...
                if (!isMobile) {
                    ...
                    $banner.css('height', 192 - pageScrollTop < 0 ? 0 : 192 - pageScrollTop);
                }
            });
